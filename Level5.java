...
public class Level5 {
    public void startLevel(Wizard wizard, Scanner scanner) {
        ...
        Item fireworks = new Item("Fireworks", 1);
        wizard.addToInventory(fireworks);
        ...
        while (umbridge.getHealth() > 0 && !fireworksUsed) {
            ...
            if (choice == 1) {
                ...
                if (wizard.getInventory().contains(fireworks)) {
                    System.out.println("You use the Fireworks in your inventory!");
                    fireworksUsed = true;
                    umbridge.setHealth(0);
                } else {
