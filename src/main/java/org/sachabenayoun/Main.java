...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        level4.startLevel(player, scanner, playerHouse.getName());

        clearScreen();
        displayMessageWithDelay("----LEVEL V----",2);
        Level5 level5 = new Level5();
        level5.startLevel(player, scanner, playerHouse.getName());

        clearScreen();
        displayMessageWithDelay("----LEVEL VI----",2);
        Level6 level6 = new Level6();
        level6.startLevel(player, scanner, playerHouse.getName());

        clearScreen();
        displayMessageWithDelay("----LEVEL VII----",2);
        Level7 level7 = new Level7();
        level7.startLevel(player, scanner, playerHouse.getName());
